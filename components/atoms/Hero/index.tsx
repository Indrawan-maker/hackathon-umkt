        ...
        <>
         <main className="w-full min-h-screen relative">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6">
                <h1 className={`text-4xl md:text-8xl text-white text-center mb-8 font-bold`}>
                    Jemari Home Spa
                </h1>
                <p className="text-sm md:text-xl text-white text-center max-w-3xl leading-relaxed tracking-wide font-medium">
